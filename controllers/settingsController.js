    ...
    try {
        ...
        if (settings) {
            ...
            res.status(200).json({
                ...
                primaryColor: '#6366f1',
                accentColor: '#818cf8',
                companyName: 'Whispra Inc.',
                contactEmail: '',
                contactPhone: '',
                address: '',
                aboutUs: 'Whispra is a secure, next-generation chat platform supporting anonymous messaging, whistleblower mode, and creator monetization.',
                founderName: 'Max Collins Botchway',
                founderInfo: 'Founder of Whispra, dedicated to privacy and secure communication for all.',
